 ...
 */
class Resultat extends \AppBundle\Entity\Resultat implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Resultat' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Resultat' . "\0" . 'formateur', '' . "\0" . 'AppBundle\\Entity\\Resultat' . "\0" . 'promo', '' . "\0" . 'AppBundle\\Entity\\Resultat' . "\0" . 'salle', '' . "\0" . 'AppBundle\\Entity\\Resultat' . "\0" . 'semaine', '' . "\0" . 'AppBundle\\Entity\\Resultat' . "\0" . 'creneau'];
        }
