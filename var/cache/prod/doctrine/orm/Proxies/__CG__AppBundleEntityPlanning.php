 ...
 */
class Planning extends \AppBundle\Entity\Planning implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Planning' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Planning' . "\0" . 'semaine', '' . "\0" . 'AppBundle\\Entity\\Planning' . "\0" . 'jour', '' . "\0" . 'AppBundle\\Entity\\Planning' . "\0" . 'demijournee'];
        }
    ...
    public function setDemijournee($demijournee)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDemijournee', [$demijournee]);
    ...
    public function getDemijournee()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDemijournee', []);
