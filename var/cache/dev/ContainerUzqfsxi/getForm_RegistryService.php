...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(['AppBundle\\Form\\DomaineType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\DomaineType']) ? $this->services['AppBundle\\Form\\DomaineType'] : ($this->services['AppBundle\\Form\\DomaineType'] = new \AppBundle\Form\DomaineType())) && false ?: '_'};
}, 'AppBundle\\Form\\FormateurType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\FormateurType']) ? $this->services['AppBundle\\Form\\FormateurType'] : ($this->services['AppBundle\\Form\\FormateurType'] = new \AppBundle\Form\FormateurType())) && false ?: '_'};
}, 'AppBundle\\Form\\PlanningType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\PlanningType']) ? $this->services['AppBundle\\Form\\PlanningType'] : ($this->services['AppBundle\\Form\\PlanningType'] = new \AppBundle\Form\PlanningType())) && false ?: '_'};
}, 'AppBundle\\Form\\PromoType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\PromoType']) ? $this->services['AppBundle\\Form\\PromoType'] : ($this->services['AppBundle\\Form\\PromoType'] = new \AppBundle\Form\PromoType())) && false ?: '_'};
}, 'AppBundle\\Form\\ResultatType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\ResultatType']) ? $this->services['AppBundle\\Form\\ResultatType'] : ($this->services['AppBundle\\Form\\ResultatType'] = new \AppBundle\Form\ResultatType())) && false ?: '_'};
}, 'AppBundle\\Form\\SalleType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\SalleType']) ? $this->services['AppBundle\\Form\\SalleType'] : ($this->services['AppBundle\\Form\\SalleType'] = new \AppBundle\Form\SalleType())) && false ?: '_'};
