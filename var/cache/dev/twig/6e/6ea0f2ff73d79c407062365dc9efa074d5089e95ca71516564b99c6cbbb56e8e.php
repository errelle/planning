...
class __TwigTemplate_c6ab659f7f2367960c22ba5688df0c8c00c4030bcecae453e589c246ffe40fc1 extends \Twig\Template
{
    ...
    ";
        ...
        if (( !(isset($context["link"]) || array_key_exists("link", $context)) || ($context["link"] ?? null))) {
            echo "<a href=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getUrl("_profiler", ["token" => ($context["token"] ?? null), "panel" => ($context["name"] ?? null)]), "html", null, true);
            echo "\">";
        }
        // line 3
...
", "@WebProfiler/Profiler/toolbar_item.html.twig", "/var/www/public/tpplanning/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views/Profiler/toolbar_item.html.twig");
    }
}
