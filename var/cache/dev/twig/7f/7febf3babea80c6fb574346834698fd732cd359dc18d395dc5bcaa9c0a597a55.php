...
class __TwigTemplate_d2d9cf16f912bcf4f5f9b5a43767f7a718a2c992446f644ece5647b279b3385b extends \Twig\Template
{
    ...
    public function block_toolbar($context, array $blocks = [])
    {
        ...
        // line 6
        echo "        ";
        echo $context["helper"]->getset_handler($this->getAttribute(($context["collector"] ?? null), "controller", []));
        echo "
    ";
    ...
    ";
        // line 9
        if ($this->getAttribute(($context["collector"] ?? null), "redirect", [])) {
            // line 10
            echo "        ";
            ob_start();
            // line 11
            echo "            ";
            echo $context["helper"]->getset_handler($this->getAttribute($this->getAttribute(($context["collector"] ?? null), "redirect", []), "controller", []), $this->getAttribute($this->getAttribute(($context["collector"] ?? null), "redirect", []), "route", []), ((("GET" != $this->getAttribute($this->getAttribute(($context["collector"] ?? null), "redirect", []), "method", []))) ? ($this->getAttribute($this->getAttribute(($context["collector"] ?? null), "redirect", []), "method", [])) : ("")));
            echo "
        ";
    ...
    ";
        ...
        if ((($this->getAttribute(($context["collector"] ?? null), "forward", [], "any", true, true)) ? (_twig_default_filter($this->getAttribute(($context["collector"] ?? null), "forward", []), false)) : (false))) {
            ...
            // line 17
            echo "            ";
            echo $context["helper"]->getset_handler($this->getAttribute($this->getAttribute(($context["collector"] ?? null), "forward", []), "controller", []));
            echo "
        ";
    ...
    ";
        ...
        if ($this->getAttribute(($context["collector"] ?? null), "route", [])) {
            ...
            ((("GET" != $this->getAttribute(($context["collector"] ?? null), "method", []))) ? (print (twig_escape_filter($this->env, $this->getAttribute(($context["collector"] ?? null), "method", []), "html", null, true))) : (print ("")));
            echo " @</span>
    ...
    ";
        ...
        echo "</span>
            ...
            ";
        // line 40
        if (("GET" != $this->getAttribute(($context["collector"] ?? null), "method", []))) {
            // line 41
            echo "<div class=\"sf-toolbar-info-piece\">
                    <b>Method</b>
                    <span>";
            // line 43
            echo twig_escape_filter($this->env, $this->getAttribute(($context["collector"] ?? null), "method", []), "html", null, true);
            echo "</span>
                </div>";
        }
        // line 46
        ...
        if ((isset($context["redirect_handler"]) || array_key_exists("redirect_handler", $context))) {
            ...
            // line 74
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["collector"] ?? null), "redirect", []), "status_code", []), "html", null, true);
            echo "</span>
                        Redirect from
                    </b>
                    <span>
            ...
            echo "
                        (<a href=\"";
            // line 79
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("_profiler", ["token" => $this->getAttribute($this->getAttribute(($context["collector"] ?? null), "redirect", []), "token", [])]), "html", null, true);
            echo "\">";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["collector"] ?? null), "redirect", []), "token", []), "html", null, true);
            echo "</a>)
                    </span>
                </div>
            </div>
        ...
        if ((isset($context["forward_handler"]) || array_key_exists("forward_handler", $context))) {
            ...
            echo "
                        (<a href=\"";
            // line 91
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("_profiler", ["token" => $this->getAttribute($this->getAttribute(($context["collector"] ?? null), "forward", []), "token", [])]), "html", null, true);
            echo "\">";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["collector"] ?? null), "forward", []), "token", []), "html", null, true);
            echo "</a>)
                    </span>
                </div>
            </div>
...
";
    ...
    <div class=\"sf-tabs\">
        ...
        if (twig_test_empty($this->getAttribute($this->getAttribute(($context["collector"] ?? null), "requestquery", []), "all", []))) {
            ...
            // line 127
            echo "                    ";
            echo twig_include($this->env, $context, "@WebProfiler/Profiler/bag.html.twig", ["bag" => $this->getAttribute(($context["collector"] ?? null), "requestquery", []), "maxDepth" => 1], false);
            echo "
                ";
        }
        // line 129
        ...
        if (twig_test_empty($this->getAttribute($this->getAttribute(($context["collector"] ?? null), "requestrequest", []), "all", []))) {
            ...
            // line 137
            echo "                    ";
            echo twig_include($this->env, $context, "@WebProfiler/Profiler/bag.html.twig", ["bag" => $this->getAttribute(($context["collector"] ?? null), "requestrequest", []), "maxDepth" => 1], false);
            echo "
                ";
        }
        // line 139
        ...
        echo "
                ...
                ";
        // line 151
        echo twig_include($this->env, $context, "@WebProfiler/Profiler/bag.html.twig", ["bag" => $this->getAttribute(($context["collector"] ?? null), "requestheaders", []), "labels" => [0 => "Header", 1 => "Value"], "maxDepth" => 1], false);
        echo "
...
($context["collector"] ?? null), "content", [])) {
        ...
        <div class=\"tab\">
            ...
            <div class=\"tab-content\">
                ...
                ";
        // line 180
        echo twig_include($this->env, $context, "@WebProfiler/Profiler/bag.html.twig", ["bag" => $this->getAttribute(($context["collector"] ?? null), "responseheaders", []), "labels" => [0 => "Header", 1 => "Value"], "maxDepth" => 1], false);
        echo "
            </div>
        </div>
        ...
        <div class=\"tab ";
        // line 184
        echo (((twig_test_empty($this->getAttribute($this->getAttribute(($context["collector"] ?? null), "requestcookies", []), "all", [])) && twig_test_empty($this->getAttribute($this->getAttribute(($context["collector"] ?? null), "responsecookies", []), "all", [])))) ? ("disabled") : (""));
        echo "\">
        ...
        echo "
                ...
                ";
        // line 200
        if (twig_test_empty($this->getAttribute($this->getAttribute(($context["collector"] ?? null), "responsecookies", []), "all", []))) {
            // line 201
            echo "                    <div class=\"empty\">
            ...
            // line 205
            echo "                    ";
            echo twig_include($this->env, $context, "@WebProfiler/Profiler/bag.html.twig", ["bag" => $this->getAttribute(($context["collector"] ?? null), "responsecookies", [])], true);
            echo "
                ";
        }
        // line 207
    ...
    public function getset_handler($__controller__ = null, $__route__ = null, $__method__ = null, ...$__varargs__)
    {
        ...
        try {
            ...
            if ($this->getAttribute(($context["controller"] ?? null), "class", [], "any", true, true)) {
                ...
                // line 289
                $context["link"] = $this->env->getExtension('Symfony\Bridge\Twig\Extension\CodeExtension')->getFileLink($this->getAttribute(($context["controller"] ?? null), "file", []), $this->getAttribute(($context["controller"] ?? null), "line", []));
                // line 290
                if (($context["link"] ?? null)) {
                    echo "<a href=\"";
                    echo twig_escape_filter($this->env, ($context["link"] ?? null), "html", null, true);
                    echo "\" title=\"";
                    echo twig_escape_filter($this->env, $this->getAttribute(($context["controller"] ?? null), "file", []), "html", null, true);
                    echo "\">";
                } else {
                    echo "<span>";
                }
                ...
                if ((((isset($context["route"]) || array_key_exists("route", $context))) ? (_twig_default_filter(($context["route"] ?? null), false)) : (false))) {
                    ...
                    // line 295
                    echo twig_escape_filter($this->env, strip_tags($this->env->getExtension('Symfony\Bridge\Twig\Extension\CodeExtension')->abbrClass($this->getAttribute(($context["controller"] ?? null), "class", []))), "html", null, true);
                    // line 296
                    (($this->getAttribute(($context["controller"] ?? null), "method", [])) ? (print (twig_escape_filter($this->env, (" :: " . $this->getAttribute(($context["controller"] ?? null), "method", [])), "html", null, true))) : (print ("")));
                }
                // line 299
                if (($context["link"] ?? null)) {
                    echo "</a>";
...
{% macro set_handler(controller, route, method) %}
    ...
    {%- endif %}
{% endmacro %}
", "@WebProfiler/Collector/request.html.twig", "/var/www/public/tpplanning/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views/Collector/request.html.twig");
    }
}
