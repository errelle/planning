...
class __TwigTemplate_1b57f89ed250d771a38ba95ea0d7d0e02eb4265fe75817eba11395df956765fc extends \Twig\Template
{
   ...
   <div class=\"container bg-info text-light col-6\">
    ...
    <table>
        ...
        $context['_seq'] = twig_ensure_traversable(($context["salles"] ?? null));
        foreach ($context['_seq'] as $context["_key"] => $context["salle"]) {
            // line 19
            echo "            <tr>
                <td><a href=\"";
            // line 20
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("salle_show", ["id" => $this->getAttribute($context["salle"], "id", [])]), "html", null, true);
            echo "\">";
            echo twig_escape_filter($this->env, $this->getAttribute($context["salle"], "id", []), "html", null, true);
            echo "</a></td>
                <td>";
            // line 21
            echo twig_escape_filter($this->env, $this->getAttribute($context["salle"], "nbplace", []), "html", null, true);
            echo "</td>
                <td>";
            // line 22
            echo twig_escape_filter($this->env, $this->getAttribute($context["salle"], "numero", []), "html", null, true);
            echo "</td>
                <td>
                    <ul>
                        <li>
            ...
            echo "\">show</a>
                        ...
                        <li>
                            <a href=\"";
            // line 29
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("salle_edit", ["id" => $this->getAttribute($context["salle"], "id", [])]), "html", null, true);
            echo "\">edit</a>
                        </li>
                    </ul>
                </td>
...
";
    ...
    {
        return array (  125 => 40,  118 => 35,  106 => 29,  100 => 26,  93 => 22,  89 => 21,  83 => 20,  80 => 19,  76 => 18,  60 => 4,  51 => 3,  29 => 1,);
    }
...
{% endblock %}
", "salle/index.html.twig", "/var/www/public/tpplanning/app/Resources/views/salle/index.html.twig");
    }
}
