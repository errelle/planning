...
class __TwigTemplate_2dbb576c312b9788741ce62515a31dc2ec8b3eb5637ce7ec5460119802243667 extends \Twig\Template
{
...
";
    ...
    <div class=\"metrics\">
        ...
        <div class=\"metric\">
            <span class=\"value\">";
        // line 79
        echo twig_escape_filter($this->env, _twig_default_filter(twig_join_filter($this->getAttribute(($context["collector"] ?? null), "fallbackLocales", []), ", "), "-"), "html", null, true);
        echo "</span>
...
";
    ...
    <div class=\"sf-tabs\">
        ...
        // line 141
        echo (($this->getAttribute(($context["collector"] ?? null), "countFallbacks", [])) ? ("status-warning") : (""));
        echo "\">";
        echo twig_escape_filter($this->env, $this->getAttribute(($context["collector"] ?? null), "countFallbacks", []), "html", null, true);
        echo "</span></h3>
        ...
        // line 162
        echo (($this->getAttribute(($context["collector"] ?? null), "countMissings", [])) ? ("status-error") : (""));
        echo "\">";
        echo twig_escape_filter($this->env, $this->getAttribute(($context["collector"] ?? null), "countMissings", []), "html", null, true);
        echo "</span></h3>
    ...
    public function block_defined_messages($context, array $blocks = [])
    {
        ...
        // line 134
        echo "                        ";
        echo $this->getAttribute(($context["helper"] ?? null), "render_table", [0 => ($context["messages_defined"] ?? null)], "method");
        echo "
                    ";
    ...
    public function block_fallback_messages($context, array $blocks = [])
    {
        ...
        // line 155
        echo "                        ";
        echo $this->getAttribute(($context["helper"] ?? null), "render_table", [0 => ($context["messages_fallback"] ?? null)], "method");
        echo "
                    ";
    ...
    public function block_missing_messages($context, array $blocks = [])
    {
        ...
        // line 177
        echo "                        ";
        echo $this->getAttribute(($context["helper"] ?? null), "render_table", [0 => ($context["messages_missing"] ?? null)], "method");
        echo "
                    ";
...
{% endmacro %}
", "@WebProfiler/Collector/translation.html.twig", "/var/www/public/tpplanning/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views/Collector/translation.html.twig");
    }
}
