...
class __TwigTemplate_045035c3c8999b94cf3f858a8c539e278db788336196bc5e4cb960c34a9e57b3 extends \Twig\Template
{
    ...
    public function block_toolbar($context, array $blocks = [])
    {
        ...
        // line 6
        echo "    ";
        if ((($this->getAttribute(($context["collector"] ?? null), "counterrors", []) || $this->getAttribute(($context["collector"] ?? null), "countdeprecations", [])) || $this->getAttribute(($context["collector"] ?? null), "countwarnings", []))) {
            // line 7
            echo "        ";
            ob_start();
            // line 8
            echo "            ";
            $context["status_color"] = (($this->getAttribute(($context["collector"] ?? null), "counterrors", [])) ? ("red") : ("yellow"));
            // line 9
            echo "            ";
            ...
            // line 10
            echo twig_escape_filter($this->env, (($this->getAttribute(($context["collector"] ?? null), "counterrors", [])) ? ($this->getAttribute(($context["collector"] ?? null), "counterrors", [])) : (($this->getAttribute(($context["collector"] ?? null), "countdeprecations", []) + $this->getAttribute(($context["collector"] ?? null), "countwarnings", [])))), "html", null, true);
            echo "</span>
        ";
        ...
        ";
            ...
            <div class=\"sf-toolbar-info-piece\">
                ...
                <span class=\"sf-toolbar-status sf-toolbar-status-";
            // line 21
            echo (($this->getAttribute(($context["collector"] ?? null), "countwarnings", [])) ? ("yellow") : (""));
            echo "\">";
    ...
    public function block_menu($context, array $blocks = [])
    {
        ...
        echo (($this->getAttribute(($context["collector"] ?? null), "counterrors", [])) ? ("error") : (((($this->getAttribute(($context["collector"] ?? null), "countdeprecations", []) || $this->getAttribute(($context["collector"] ?? null), "countwarnings", []))) ? ("warning") : (""))));
        echo " ";
...
";
    ...
    ";
        ...
        <div class=\"sf-tabs\">
            ...
            // line 70
            echo (($this->getAttribute(($context["collector"] ?? null), "counterrors", [])) ? ("error") : ((($this->getAttribute(($context["collector"] ?? null), "countwarnings", [])) ? ("warning") : (""))));
            echo "\">";
            echo twig_escape_filter($this->env, (($this->getAttribute(($context["collector"] ?? null), "counterrors", [])) ? ($this->getAttribute(($context["collector"] ?? null), "counterrors", [])) : (twig_length_filter($this->env, ($context["info_and_error_logs"] ?? null)))), "html", null, true);
            echo "</span></h3>
            ...
            echo (($this->getAttribute(($context["collector"] ?? null), "countdeprecations", [])) ? ("warning") : (""));
            echo "\">";
            echo twig_escape_filter($this->env, (($this->getAttribute(($context["collector"] ?? null), "countdeprecations", [], "any", true, true)) ? (_twig_default_filter($this->getAttribute(($context["collector"] ?? null), "countdeprecations", []), 0)) : (0)), "html", null, true);
            echo "</span></h3>
            ...
            echo "            ";
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable($this->getAttribute(($context["collector"] ?? null), "compilerLogs", []));
            ...
            echo "</span></h3>
                ...
                <div class=\"tab-content\">
                    ";
            // line 140
            if (twig_test_empty($this->getAttribute(($context["collector"] ?? null), "compilerLogs", []))) {
                // line 141
                echo "                        <div class=\"empty\">
...
$context["log"], "priorityName", []) == "WARNING")) ? ("status-warning") : (""))))));
                ...
                echo "
                    <td class=\"font-normal\">";
                // line 219
                echo $context["helper"]->getrender_log_message(($context["category"] ?? null), $this->getAttribute($context["loop"], "index", []), $context["log"]);
                echo "</td>
                </tr>
            ";
                ++$context['loop']['index0'];
...
";
    ...
    public function getrender_log_message($__category__ = null, $__log_index__ = null, $__log__ = null, ...$__varargs__)
    {
        ...
        try {
            ...
            // line 227
            echo "    ";
            $context["has_context"] = ($this->getAttribute(($context["log"] ?? null), "context", [], "any", true, true) &&  !twig_test_empty($this->getAttribute(($context["log"] ?? null), "context", [])));
            // line 228
            echo "    ";
    ...
    ";
            ...
            if ( !($context["has_context"] ?? null)) {
                // line 231
                echo "        ";
                echo $this->env->getExtension('Symfony\Bundle\WebProfilerBundle\Twig\WebProfilerExtension')->dumpLog($this->env, $this->getAttribute(($context["log"] ?? null), "message", []));
                echo "
    ";
            } else {
                // line 233
                echo "        ";
                echo $this->env->getExtension('Symfony\Bundle\WebProfilerBundle\Twig\WebProfilerExtension')->dumpLog($this->env, $this->getAttribute(($context["log"] ?? null), "message", []), $this->getAttribute(($context["log"] ?? null), "context", []));
                echo "
        ...
        <div id=\"";
            ...
            ";
                // line 247
                echo call_user_func_array($this->env->getFunction('profiler_dump')->getCallable(), [$this->env, $this->getAttribute(($context["log"] ?? null), "context", []), 1]);
                echo "
        </div>
        ...
        ";
                ...
                ";
                    // line 252
                    echo call_user_func_array($this->env->getFunction('profiler_dump')->getCallable(), [$this->env, $this->getAttribute($this->getAttribute($this->getAttribute(($context["log"] ?? null), "context", []), "exception", []), "trace", []), 1]);
                    echo "
            </div>
        ";
                }
...
{% macro render_log_message(category, log_index, log) %}
    ...
    {% endif %}
{% endmacro %}
", "@WebProfiler/Collector/logger.html.twig", "/var/www/public/tpplanning/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views/Collector/logger.html.twig");
    }
}
