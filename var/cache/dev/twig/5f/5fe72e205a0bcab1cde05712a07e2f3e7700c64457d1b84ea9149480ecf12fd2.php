...
class __TwigTemplate_b33cffb04fa8081e23d56c8147588fe14a7dc7cdeffe73bc834a13a3768ebb16 extends \Twig\Template
{
    ...
    <table>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["formateur"]) {
            ...
            echo "            <tr>
                <td><a href=\"";
            // line 20
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("formateur_show", ["id" => $this->getAttribute($context["formateur"], "id", [])]), "html", null, true);
            echo "\">";
            echo twig_escape_filter($this->env, $this->getAttribute($context["formateur"], "id", []), "html", null, true);
            echo "</a></td>
                <td>";
            // line 21
            echo twig_escape_filter($this->env, $this->getAttribute($context["formateur"], "nom", []), "html", null, true);
            echo "</td>
                <td>";
            // line 22
            echo twig_escape_filter($this->env, $this->getAttribute($context["formateur"], "prenom", []), "html", null, true);
            echo "</td>
                <td>
                    <ul>
                        <li>
            ...
            echo "\">show</a>
                        ...
                        <li>
                            <a href=\"";
            // line 29
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("formateur_edit", ["id" => $this->getAttribute($context["formateur"], "id", [])]), "html", null, true);
            echo "\">edit</a>
                        </li>
                    </ul>
                </td>
...
{% endblock %}
", "formateur/index.html.twig", "/var/www/public/tpplanning/app/Resources/views/formateur/index.html.twig");
    }
}
