...
class __TwigTemplate_542fd632f502dd26610198e6c4478ad0abb844d3403fa3f13177a5b72d021c6f extends \Twig\Template
{
    ...
    public function block_toolbar($context, array $blocks = [])
    {
        ...
        // line 6
        echo "    ";
        if ($this->getAttribute(($context["collector"] ?? null), "token", [])) {
            // line 7
            echo "        ";
    ...
    ";
        ...
        // line 19
        echo "        ";
        if ($this->getAttribute(($context["collector"] ?? null), "impersonated", [])) {
            // line 20
            echo "            <div class=\"sf-toolbar-info-group\">
                <div class=\"sf-toolbar-info-piece\">
                    ...
                    <span>";
            // line 23
            echo twig_escape_filter($this->env, $this->getAttribute(($context["collector"] ?? null), "impersonatorUser", []), "html", null, true);
            echo "</span>
                </div>
            </div>
        ";
        ...
        <div class=\"sf-toolbar-info-group\">
            ";
        // line 29
        if ($this->getAttribute(($context["collector"] ?? null), "enabled", [])) {
            // line 30
            echo "                ";
            if ($this->getAttribute(($context["collector"] ?? null), "token", [])) {
                // line 31
            ...
            echo "
                ";
            // line 52
            if ($this->getAttribute(($context["collector"] ?? null), "firewall", [])) {
                // line 53
                echo "                    <div class=\"sf-toolbar-info-piece\">
                        <b>Firewall name</b>
                        <span>";
                // line 55
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["collector"] ?? null), "firewall", []), "name", []), "html", null, true);
                echo "</span>
                    </div>
                ";
            }
            ...
            echo "
                ";
            // line 59
            if (($this->getAttribute(($context["collector"] ?? null), "token", []) && $this->getAttribute(($context["collector"] ?? null), "logoutUrl", []))) {
                // line 60
                echo "                    <div class=\"sf-toolbar-info-piece\">
                        <b>Actions</b>
                        <span>
                ...
                echo "\">Logout</a>
                            ";
                // line 64
                if (($this->getAttribute(($context["collector"] ?? null), "impersonated", []) && $this->getAttribute(($context["collector"] ?? null), "impersonationExitPath", []))) {
                    // line 65
                    echo "                                | <a href=\"";
                    echo twig_escape_filter($this->env, $this->getAttribute(($context["collector"] ?? null), "impersonationExitPath", []), "html", null, true);
...
";
    ...
    public function block_menu($context, array $blocks = [])
    {
        ...
        echo ((( !$this->getAttribute(($context["collector"] ?? null), "enabled", []) ||  !$this->getAttribute(($context["collector"] ?? null), "token", []))) ? ("disabled") : (""));
        echo "\">
        <span class=\"icon\">";
        // line 83
        echo twig_include($this->env, $context, "@Security/Collector/icon.svg");
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            ";
                // line 116
                echo ((twig_test_empty($this->getAttribute(($context["collector"] ?? null), "roles", []))) ? ("none") : (call_user_func_array($this->env->getFunction('profiler_dump')->getCallable(), [$this->env, $this->getAttribute(($context["collector"] ?? null), "roles", []), 1])));
                echo "
                ...
                if ($this->getAttribute(($context["collector"] ?? null), "supportsRoleHierarchy", [])) {
                    ...
                    echo "                    <tr>
                        ...
                        <td>";
                    // line 127
                    echo ((twig_test_empty($this->getAttribute(($context["collector"] ?? null), "inheritedRoles", []))) ? ("none") : (call_user_func_array($this->env->getFunction('profiler_dump')->getCallable(), [$this->env, $this->getAttribute(($context["collector"] ?? null), "inheritedRoles", []), 1])));
                    echo "</td>
                    </tr>
                    ";
                }
                ...
                if ($this->getAttribute(($context["collector"] ?? null), "token", [])) {
                    ...
                    echo "                    <tr>
                        ...
                        <td>";
                    // line 134
                    echo call_user_func_array($this->env->getFunction('profiler_dump')->getCallable(), [$this->env, $this->getAttribute(($context["collector"] ?? null), "token", [])]);
                    echo "</td>
                    </tr>
                    ";
                }
...
($context["collector"] ?? null), "enabled", [])) {
        ...
        ";
            ...
            if ($this->getAttribute(($context["collector"] ?? null), "firewall", [])) {
                ...
                <div class=\"metric\">
                    <span class=\"value\">";
                // line 155
                echo twig_include($this->env, $context, (("@WebProfiler/Icon/" . (($this->getAttribute($this->getAttribute(($context["collector"] ?? null), "firewall", []), "security_enabled", [])) ? ("yes") : ("no"))) . ".svg"));
                echo "</span>
                ...
                <div class=\"metric\">
                    <span class=\"value\">";
                // line 159
                echo twig_include($this->env, $context, (("@WebProfiler/Icon/" . (($this->getAttribute($this->getAttribute(($context["collector"] ?? null), "firewall", []), "stateless", [])) ? ("yes") : ("no"))) . ".svg"));
                echo "</span>
                ...
                <div class=\"metric\">
                    <span class=\"value\">";
                // line 163
                echo twig_include($this->env, $context, (("@WebProfiler/Icon/" . (($this->getAttribute($this->getAttribute(($context["collector"] ?? null), "firewall", []), "allows_anonymous", [])) ? ("yes") : ("no"))) . ".svg"));
                echo "</span>
            ...
            ";
                // line 168
                if ($this->getAttribute($this->getAttribute(($context["collector"] ?? null), "firewall", []), "security_enabled", [])) {
                    // line 169
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>";
                    // line 181
                    (($this->getAttribute($this->getAttribute(($context["collector"] ?? null), "firewall", []), "provider", [])) ? (print (twig_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["collector"] ?? null), "firewall", []), "provider", []), "html", null, true))) : (print ("(none)")));
                    echo "</td>
                        </tr>
                        <tr>
                            <th>context</th>
                            <td>";
                    // line 185
                    (($this->getAttribute($this->getAttribute(($context["collector"] ?? null), "firewall", []), "context", [])) ? (print (twig_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["collector"] ?? null), "firewall", []), "context", []), "html", null, true))) : (print ("(none)")));
                    echo "</td>
                        </tr>
                        <tr>
                            <th>entry_point</th>
                            <td>";
                    // line 189
                    (($this->getAttribute($this->getAttribute(($context["collector"] ?? null), "firewall", []), "entry_point", [])) ? (print (twig_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["collector"] ?? null), "firewall", []), "entry_point", []), "html", null, true))) : (print ("(none)")));
                    echo "</td>
                        </tr>
                        <tr>
                            <th>user_checker</th>
                            <td>";
                    // line 193
                    (($this->getAttribute($this->getAttribute(($context["collector"] ?? null), "firewall", []), "user_checker", [])) ? (print (twig_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["collector"] ?? null), "firewall", []), "user_checker", []), "html", null, true))) : (print ("(none)")));
                    echo "</td>
                        </tr>
                        <tr>
                            ...
                            <td>";
                    // line 197
                    (($this->getAttribute($this->getAttribute(($context["collector"] ?? null), "firewall", []), "access_denied_handler", [])) ? (print (twig_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["collector"] ?? null), "firewall", []), "access_denied_handler", []), "html", null, true))) : (print ("(none)")));
                    echo "</td>
                        </tr>
                        <tr>
                            ...
                            <td>";
                    // line 201
                    (($this->getAttribute($this->getAttribute(($context["collector"] ?? null), "firewall", []), "access_denied_url", [])) ? (print (twig_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["collector"] ?? null), "firewall", []), "access_denied_url", []), "html", null, true))) : (print ("(none)")));
                    echo "</td>
                        </tr>
                        <tr>
                            <th>listeners</th>
                            <td>";
                    // line 205
                    echo ((twig_test_empty($this->getAttribute($this->getAttribute(($context["collector"] ?? null), "firewall", []), "listeners", []))) ? ("(none)") : (call_user_func_array($this->env->getFunction('profiler_dump')->getCallable(), [$this->env, $this->getAttribute($this->getAttribute(($context["collector"] ?? null), "firewall", []), "listeners", []), 1])));
                    echo "</td>
                        </tr>
                    </tbody>
                </table>
                ...
                ";
                        ...
                        ";
                        // line 226
                        $context["previous_event"] = twig_first($this->env, $this->getAttribute(($context["collector"] ?? null), "listeners", []));
                        // line 227
                        echo "                        ";
                        $context['_parent'] = $context;
                        $context['_seq'] = twig_ensure_traversable($this->getAttribute(($context["collector"] ?? null), "listeners", []));
                        $context['loop'] = [
                        ...
                        foreach ($context['_seq'] as $context["_key"] => $context["listener"]) {
                            // line 228
                            echo "                            ";
                            if (($this->getAttribute($context["loop"], "first", []) || ($context["listener"] != ($context["previous_event"] ?? null)))) {
                                // line 229
                                echo "                                ";
    ...
    ";
        ...
        if ( !twig_test_empty((($this->getAttribute(($context["collector"] ?? null), "voters", [], "any", true, true)) ? (_twig_default_filter($this->getAttribute(($context["collector"] ?? null), "voters", []), [])) : ([])))) {
            ...
            echo twig_escape_filter($this->env, twig_length_filter($this->env, $this->getAttribute(($context["collector"] ?? null), "voters", [])), "html", null, true);
            echo ")</small></h2>
        ...
        <table class=\"voters\">
            ...
            // line 280
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable($this->getAttribute(($context["collector"] ?? null), "voters", []));
            $context['loop'] = [
              'parent' => $context['_parent'],
              'index0' => 0,
              'index'  => 1,
    ...
    ";
        ...
        <table class=\"decision-log\">
            ...
            // line 309
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable($this->getAttribute(($context["collector"] ?? null), "accessDecisionLog", []));
            $context['loop'] = [
              'parent' => $context['_parent'],
              'index0' => 0,
              'index'  => 1,
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["decision"]) {
                ...
                if ((twig_length_filter($this->env, $this->getAttribute($context["decision"], "attributes", [])) == 1)) {
                    ...
                    if ($this->getAttribute(($context["attribute"] ?? null), "expression", [], "any", true, true)) {
                        ...
                        echo twig_escape_filter($this->env, $this->getAttribute(($context["attribute"] ?? null), "expression", []), "html", null, true);
                        echo "</code></pre>
                                ";
...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@Security/Collector/security.html.twig", "/var/www/public/tpplanning/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views/Collector/security.html.twig");
    }
}
