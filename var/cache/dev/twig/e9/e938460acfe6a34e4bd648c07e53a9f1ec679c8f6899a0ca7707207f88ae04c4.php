...
class __TwigTemplate_4b75abe96121f8ef03f092355e2ccf66183e173b0d91dc21c5591a77f0df7658 extends \Twig\Template
{
    ...
    public function block_toolbar($context, array $blocks = [])
    {
        ...
        // line 17
        echo "    ";
        $context["has_time_events"] = (twig_length_filter($this->env, $this->getAttribute(($context["collector"] ?? null), "events", [])) > 0);
        // line 18
        echo "
    ";
        // line 19
        $context["total_time"] = ((($context["has_time_events"] ?? null)) ? (sprintf("%.0f", $this->getAttribute(($context["collector"] ?? null), "duration", []))) : ("n/a"));
        // line 20
        echo "    ";
        ...
        // line 21
        echo "    ";
        $context["status_color"] = (((($context["has_time_events"] ?? null) && ($this->getAttribute(($context["collector"] ?? null), "duration", []) > 1000))) ? ("yellow") : (""));
        // line 22
        echo "
    ";
        // line 23
...
";
    ...
    ";
        // line 98
        if ( !$this->getAttribute(($context["collector"] ?? null), "isStopwatchInstalled", [], "method")) {
            // line 99
...
($context["collector"] ?? null), "events", []))) {
    ...
    ";
        ...
        if ($this->getAttribute(($context["profile"] ?? null), "parent", [])) {
            ...
            Sub-Request ";
            // line 121
            echo call_user_func_array($this->env->getFunction('profiler_dump')->getCallable(), [$this->env, $this->getAttribute($this->getAttribute($this->getAttribute(($context["profile"] ?? null), "getcollector", [0 => "request"], "method"), "requestattributes", []), "get", [0 => "_controller"], "method")]);
            echo "
            <small>
                ";
            // line 123
...
";
            // line 518
            echo $context["__internal_c0f1a48f700124002ea05b7f418c981e388f8465386ea49d51c5f279e00ae239"]->getdump_events(($context["events"] ?? null));
            echo "
                    ]
                }
";
...
{% endmacro %}
", "@WebProfiler/Collector/time.html.twig", "/var/www/public/tpplanning/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views/Collector/time.html.twig");
    }
}
