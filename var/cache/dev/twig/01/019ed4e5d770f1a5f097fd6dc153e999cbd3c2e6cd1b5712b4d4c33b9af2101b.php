...
class __TwigTemplate_cc26ae7ee11887962a90d2d1a9b704fcef288a8dd995b9c786c9e04c129ce8ea extends \Twig\Template
{
    ...
    ";
        ...
        <div id=\"tree-details-container\">
            ...
            foreach ($context['_seq'] as $context["formName"] => $context["formData"]) {
                // line 203
                echo "                ";
                echo $context["__internal_602b25b77fb76a01c71c656c2301796740437e6f0036807e247dd0504eef4577"]->getform_tree_details($context["formName"], $context["formData"], $this->getAttribute($this->getAttribute(($context["collector"] ?? null), "data", []), "forms_by_hash", []), $this->getAttribute($context["loop"], "first", []));
                echo "
            ";
                ++$context['loop']['index0'];
                ++$context['loop']['index'];
...
";
    ...
    public function getform_tree_entry($__name__ = null, $__data__ = null, $__is_root__ = null, ...$__varargs__)
    {
        ...
        try {
            ...
            // line 433
            echo "    ";
            $context["has_error"] = ($this->getAttribute(($context["data"] ?? null), "errors", [], "any", true, true) && (twig_length_filter($this->env, $this->getAttribute(($context["data"] ?? null), "errors", [])) > 0));
            // line 434
            echo "    <li>
        <div class=\"tree-inner\" data-tab-target-id=\"";
            ...
            <span ";
            // line 446
            if ((($context["has_error"] ?? null) || (($this->getAttribute(($context["data"] ?? null), "has_children_error", [], "any", true, true)) ? (_twig_default_filter($this->getAttribute(($context["data"] ?? null), "has_children_error", []), false)) : (false)))) {
        ...
        ";
            ...
            if ( !twig_test_empty($this->getAttribute(($context["data"] ?? null), "children", []))) {
                ...
                echo twig_escape_filter($this->env, $this->getAttribute(($context["data"] ?? null), "id", []), "html", null, true);
                echo "-children\" ";
                if (( !($context["is_root"] ?? null) &&  !(($this->getAttribute(($context["data"] ?? null), "has_children_error", [], "any", true, true)) ? (_twig_default_filter($this->getAttribute(($context["data"] ?? null), "has_children_error", []), false)) : (false)))) {
                    echo "class=\"hidden\"";
                }
                echo ">
                ";
    ...
    public function getform_tree_details($__name__ = null, $__data__ = null, $__forms_by_hash__ = null, $__show__ = null, ...$__varargs__)
    {
        ...
        ";
            ...
            if ($this->getAttribute(($context["data"] ?? null), "type_class", [], "any", true, true)) {
                ...
                echo call_user_func_array($this->env->getFunction('profiler_dump')->getCallable(), [$this->env, $this->getAttribute(($context["data"] ?? null), "type_class", [])]);
                echo "</h3>
        ";
            }
            // line 468
        ...
        <div id=\"";
            ...
            <table>
                ...
                if ($this->getAttribute($this->getAttribute(($context["data"] ?? null), "default_data", [], "any", false, true), "model", [], "any", true, true)) {
                    // line 535
                    echo "                                ";
                    echo call_user_func_array($this->env->getFunction('profiler_dump')->getCallable(), [$this->env, $this->getAttribute($this->getAttribute(($context["data"] ?? null), "default_data", []), "seek", [0 => "model"], "method")]);
                    echo "
                            ";
                } else {
                    // line 537
                ...
                echo "                        </td>
                    ...
                    <tr>
                        ...
                        <td>";
                // line 543
                echo call_user_func_array($this->env->getFunction('profiler_dump')->getCallable(), [$this->env, $this->getAttribute($this->getAttribute(($context["data"] ?? null), "default_data", []), "seek", [0 => "norm"], "method")]);
                echo "</td>
                    </tr>
                    <tr>
                ...
                if ($this->getAttribute($this->getAttribute(($context["data"] ?? null), "default_data", [], "any", false, true), "view", [], "any", true, true)) {
                    // line 549
                    echo "                                ";
                    echo call_user_func_array($this->env->getFunction('profiler_dump')->getCallable(), [$this->env, $this->getAttribute($this->getAttribute(($context["data"] ?? null), "default_data", []), "seek", [0 => "view"], "method")]);
                    echo "
                            ";
                } else {
                    // line 551
        ...
        ";
                ...
                <tbody>
                    ...
                    if ($this->getAttribute($this->getAttribute(($context["data"] ?? null), "submitted_data", [], "any", false, true), "view", [], "any", true, true)) {
                        // line 581
                        echo "                                ";
                        echo call_user_func_array($this->env->getFunction('profiler_dump')->getCallable(), [$this->env, $this->getAttribute($this->getAttribute(($context["data"] ?? null), "submitted_data", []), "seek", [0 => "view"], "method")]);
                        echo "
                            ";
                    } else {
                        // line 583
                    ...
                    <tr>
                        ...
                        <td>";
                    // line 589
                    echo call_user_func_array($this->env->getFunction('profiler_dump')->getCallable(), [$this->env, $this->getAttribute($this->getAttribute(($context["data"] ?? null), "submitted_data", []), "seek", [0 => "norm"], "method")]);
                    echo "</td>
                    </tr>
                    <tr>
                        <th class=\"font-normal\" scope=\"row\">Model Format</th>
                    ...
                    if ($this->getAttribute($this->getAttribute(($context["data"] ?? null), "submitted_data", [], "any", false, true), "model", [], "any", true, true)) {
                        // line 595
                        echo "                                ";
                        echo call_user_func_array($this->env->getFunction('profiler_dump')->getCallable(), [$this->env, $this->getAttribute($this->getAttribute(($context["data"] ?? null), "submitted_data", []), "seek", [0 => "model"], "method")]);
                        echo "
                            ";
                    } else {
                        // line 597
            ...
            ";
                ...
                ";
                    ...
                    <td>
                        ...
                        // line 636
                        echo "                        ";
                        $context["resolved_option_value"] = (($this->getAttribute($this->getAttribute($this->getAttribute(($context["data"] ?? null), "resolved_options", [], "any", false, true), $context["option"], [], "array", false, true), "value", [], "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->getAttribute($this->getAttribute(($context["data"] ?? null), "resolved_options", [], "any", false, true), $context["option"], [], "array", false, true), "value", []), $this->getAttribute($this->getAttribute(($context["data"] ?? null), "resolved_options", []), $context["option"], [], "array"))) : ($this->getAttribute($this->getAttribute(($context["data"] ?? null), "resolved_options", []), $context["option"], [], "array")));
                        // line 637
                        echo "                        ";
                        ...
                        ";
                            ...
                            // line 640
                            echo "                            ";
                            echo call_user_func_array($this->env->getFunction('profiler_dump')->getCallable(), [$this->env, $this->getAttribute($this->getAttribute(($context["data"] ?? null), "resolved_options", []), "seek", [0 => $context["option"]], "method")]);
                            echo "
                        ";
                        }
                        // line 642
...
{% macro form_tree_details(name, data, forms_by_hash, show) %}
    ...
    {% endfor %}
{% endmacro %}
", "@WebProfiler/Collector/form.html.twig", "/var/www/public/tpplanning/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views/Collector/form.html.twig");
    }
}
