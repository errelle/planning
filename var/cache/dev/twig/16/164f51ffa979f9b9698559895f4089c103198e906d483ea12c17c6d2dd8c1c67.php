...
class __TwigTemplate_8515f627fa1329c93ed8b80140f53b4e60be83899836685220f34a3612a4848a extends \Twig\Template
{
   ...
   <div class=\"container bg-info text-light col-6\">
    ...
    <table>
        <tbody>
            <tr>
                ...
                <td>";
        // line 12
        echo twig_escape_filter($this->env, $this->getAttribute(($context["formateur"] ?? null), "id", []), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>Nom</th>
                <td>";
        // line 16
        echo twig_escape_filter($this->env, $this->getAttribute(($context["formateur"] ?? null), "nom", []), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>Prenom</th>
                <td>";
        // line 20
        echo twig_escape_filter($this->env, $this->getAttribute(($context["formateur"] ?? null), "prenom", []), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>Domaine</th>
                <td>";
        // line 24
        echo twig_escape_filter($this->env, $this->getAttribute(($context["formateur"] ?? null), "domaine", []), "html", null, true);
        echo "</td>
            </tr>
        </tbody>
    </table>
    ...
    <ul>
        ...
        <li>
            <a href=\"";
        // line 34
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("formateur_edit", ["id" => $this->getAttribute(($context["formateur"] ?? null), "id", [])]), "html", null, true);
        echo "\">Edit</a>
        </li>
        <li>
            ";
...
{% endblock %}
", "formateur/show.html.twig", "/var/www/public/tpplanning/app/Resources/views/formateur/show.html.twig");
    }
}
